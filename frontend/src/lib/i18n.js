const T = {
  en: {
    ...
    cooked_weight_ph: 'Cooked weight (g)',
    save_recipe: 'Save recipe',
    err_recipe_name_req: 'Recipe name is required',
  ...
  uk: {
    ...
    tab_meal: 'Страва',
    tab_recipe: 'Рецепт',
    recipe_name_ph: 'Назва рецепту',
    ingredients: 'Інгредієнти',
    cooked_weight_ph: 'Вага готового (г)',
    save_recipe: 'Зберегти рецепт',
    err_recipe_name_req: "Назва рецепту обов'язкова",
